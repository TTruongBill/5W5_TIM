...
if(nbProf == enseignants.length - 1){
...
arrows[0].addEventListener("mousedown", () => {
    ...
    if(nbProf > 0 && nbProf != 1){//si nbProf est plus grand que 0 et plus petit ou egal à 14
        ...
        nbProf = enseignants.length - 1;//mettre nbProf à 13
...
arrows[1].addEventListener("mousedown", () => {
    ...
    if(nbProf < enseignants.length - 1 && nbProf != enseignants.length - 2 ) {//si nbProf est plus grand ou egal que 0 et plus petit que 13
        imgCarrousel[nbProf].style.display = "flex";
        nbProf++;//Incrémenter
        imgCarrousel[nbProf].style.display = "flex";
        imgCarrousel[nbProf + 1].style.display = "flex";

    }else if(nbProf == enseignants.length - 2){//sinon si nbProf est égal à 13
        imgCarrousel[nbProf].style.display = "flex";
        nbProf++;//Décrémenter
        imgCarrousel[nbProf].style.display = "flex";
        imgCarrousel[0].style.display = "flex";
        imgCarrousel[0].style.order = "1";
    }else if(nbProf == enseignants.length - 1){//sinon si nbProf est égal à 13
        imgCarrousel[nbProf].style.display = "flex";
        imgCarrousel[nbProf].style.order = "-1";
...
function enleverProf(){
    ...
    if(nbProf => 0 && nbProf < enseignants.length){
